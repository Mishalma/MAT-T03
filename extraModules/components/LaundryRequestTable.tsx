...
interface LaundryRequestTableProps {
...
const LaundryRequestTable: React.FC<LaundryRequestTableProps> = ({ requests }) => {
    return (
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-700">
            <h2 className="text-lg font-semibold text-gray-100 mb-4 px-2">Laundry Requests</h2>
...
export default LaundryRequestTable;
